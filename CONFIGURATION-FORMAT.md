...
| `shareName` | string | Yes | The SMB share path component, e.g. `Outputs` in `smb://server/Outputs`. |
...
<array>
  <dict>
    <key>alias</key>       <string>Outputs NAS</string>
    <key>protocol</key>    <string>smb</string>
    <key>shareName</key>   <string>Outputs</string>
    <key>mountName</key>   <string>Outputs</string>
    <key>defaultUsername</key> <string>editor</string>
    <key>note</key>        <string>Preferred 10GbE, fallback 1GbE.</string>
    <key>endpoints</key>
    <array>
      <dict>
        <key>serverIP</key>     <string>10.0.1.245</string>
